<template>
  <div class="author-container">
    <a
      href="https://tieba.baidu.com/home/main?id=tb.1.9b09c627.4LoOzN6MrpCOkeuc4sLdLw?t=1769776474&fr=index#"
      target="_blank"
      class="author-link"
    ...
    <div>
      <p>本来是只打算写个登录器的，该功能纯属作者闲的手痒顺手做的</p>
      <p>除了和觉醒官方接口打交道外没有任何联网行为，这也代表着该工具是永远免费的</p>
