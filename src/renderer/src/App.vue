  ...
  <div class="app-container">
    <CustomTitleBar>
      <template #nav>
        ...
        />
        <button class="nav-btn" title="游戏官网">
          <a href="https://r2beat.xiyouxi.com/" target="_blank">
            <span class="nav-icon">🌐</span>
            <span class="nav-text">游戏官网</span>
          </a>
        </button>
        <button class="nav-btn" title="充值中心" @click="handleNavClick('recharge')">
          <span class="nav-icon">💎</span>
          <span class="nav-text">充值中心</span>
        </button>
        <button class="nav-btn" title="设置" @click="handleNavClick('settings')">
